...
#if defined(CONFIG_MACH_SONY_DISCOVERY) || defined(CONFIG_MACH_SONY_DISCOVERY_DSDS) || defined(CONFIG_MACH_SONY_KIRIN) || defined(CONFIG_MACH_SONY_KIRIN_DSDS) || defined( CONFIG_MACH_SONY_MERMAID) || defined(CONFIG_MACH_SONY_MERMAID_DSDS)
...
#endif // #if defined(CONFIG_MACH_SONY_DISCOVERY) || defined(CONFIG_MACH_SONY_DISCOVERY_DSDS) || defined(CONFIG_MACH_SONY_KIRIN) || defined(CONFIG_MACH_SONY_KIRIN_DSDS) || defined( CONFIG_MACH_SONY_MERMAID) || defined(CONFIG_MACH_SONY_MERMAID_DSDS)
